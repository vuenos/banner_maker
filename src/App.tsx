...
function App() {
    ...
    const handleRandomWording = () => {
        const randomIndex = Math.floor(
            Math.random() * arrRandomWordings.length,
        );
    ...
    return (
        <>
            ...
            >
                ...
                <a href="mailto: vuenos@gmail.com" style={{ color: "#FFFFFF" }}>
                    Contact
                </a>
            </Tag>
            <Row justify="center" style={{ padding: "16px" }}>
                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                    ...
                    <Title id="page-title" style={{ marginTop: 0 }} level={2}>
                        Banner created by entering text
                    </Title>
                </Col>
            </Row>
                ...
                <Col xs={24} sm={24} md={24} lg={6} xl={6}>
                    ...
                    <Row style={{ marginTop: "16px" }}>
                        <Button
                            type="default"
                            size="small"
                            onClick={() => ratioChangeHandler("960", "540")}
                        >
                            16 : 9
                        </Button>
                        <Button
                            type="default"
                            size="small"
                            onClick={() => ratioChangeHandler("360", "640")}
                        ...
                        <Button
                            type="default"
                            size="small"
                            onClick={() => ratioChangeHandler("1280", "720")}
                            style={{ marginLeft: "8px" }}
                        >
                            Youtube
                        </Button>
                                ...
                                options={[
                                    {
                                        value: "Song Myung",
                                        label: "Song Myung",
                                        className: "ff-song-myung",
                                    },
                                    {
                                        value: "Yeon Sung",
                                        label: "Yeon Sung",
                                        className: "ff-yeon-sung",
                                    },
                                    {
                                        value: "Noto Sans KR",
                                        label: "Noto Sans KR",
                                        className: "ff-noto-kr",
                                    },
                                    {
                                        value: "Noto Serif KR",
                                        label: "Noto Serif KR",
                                        className: "ff-noto-serif",
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        value: "Single Day",
                                        label: "Single Day",
                                        className: "ff-single-day",
                                    },
                                    {
                                        value: "Nanum Pen Script",
                                        label: "Nanum Pen Script",
                                        className: "ff-nanum-pen",
                                    },
                                    {
                                        value: "PT Serif",
                                        label: "PT Serif",
                                        className: "ff-PT-serif",
                                    },
                                    {
                                        value: "Roboto",
                                        label: "Roboto",
                ...
                <Col xs={24} sm={24} md={24} lg={16} xl={16}>
                    <Row justify="center">
                        <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                            ...
                            >
                                <ExclamationCircleOutlined /> Click on the text
                                and edit it
                            </Text>
                        </Col>
                    </Row>
